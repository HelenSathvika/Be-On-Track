...
'''Creating table to store interviewbit coding contest data'''

sql = '''CREATE TABLE interviewbit(id  SERIAL NOT NULL,name varchar(30) not null,date varchar(30) not null)'''
cursor.execute(sql)

''' webscrapping data from specified url of website'''
...
'''Creating table to store hackerearth coding contest data'''
...
'''Creating table to store coding contest data'''
